    ...
    Array.isArray(data) && data.length > 0 ? data.map((item) => (
      <tr key={item.id} className="bg-gray-100">
        ...
        <td className="border px-4 py-2 text-center">
          ...
          <button onClick={() => handleDelete(item.id)} className="hover:text-white hover:bg-red-600  text-black font-bold py-1 px-2 rounded">
            <FaTrash />
          </button>
          <button onClick={() => changeEtat(item.id)} className="hover:text-white hover:bg-red-600  text-black font-bold py-1 px-2 rounded">
          <FaTimesCircle/>
          </button>
        </td>
      </tr>
